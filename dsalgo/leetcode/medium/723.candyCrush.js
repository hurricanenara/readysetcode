...
// Runtime: 96 ms, faster than 88.26% of JavaScript online submissions for Candy Crush.
// Memory Usage: 40.8 MB, less than 80.28% of JavaScript online submissions for Candy Crush.
    ...
    for (let r = 0; r < board.length; r++) {
        for (let c = 0; c < board[0].length - 2; c++) {
            ...
            if (num1 === num2 && num2 === num3 && num1 !== 0) {
                // console.log("switches left in row");
                board[r][c] = -num1;
                board[r][c + 1] = -num2;
                board[r][c + 2] = -num3;
                isDone = false;
